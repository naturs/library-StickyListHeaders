...
public class StickyListHeadersListView extends FrameLayout {
	...
	static final String LOG_TAG = StickyListHeadersListView.class.getSimpleName();
...
//			L.d(LOG_TAG, "header measuredWidth:%d, measuredHeight:%d.", header.getMeasuredWidth(), header.getMeasuredHeight());
		}
			...
			if (mOnHeaderClickListener != null) {
				...
				if (mHeader != null) {
					mHeader.setOnClickListener(new OnClickListener() {
						@Override
						public void onClick(View v) {
							mOnHeaderClickListener.onHeaderClick(StickyListHeadersListView.this, mHeader,
